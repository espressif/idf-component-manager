...
class ManifestBuilder(object):
    ...
    def build(self):
        ...
        manifest = Manifest(name=tree.get("name", None), maintainers=tree.get("maintainers", None))
        ...
        for name, details in tree.get("dependencies", {}).items():
            ...
            component = ComponentRequirement(name, source, version_spec=details["version"])
